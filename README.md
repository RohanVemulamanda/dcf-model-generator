...
**[Try it live](https://dcf-model-generator-frdfqkttuvhky3zve5fksv.streamlit.app)**

---

## Why this exists

This started as a hand-built FCFF DCF model for Johnson & Johnson (see that project [here](https://github.com/RohanVemulamanda/jnj-dcf-valuation)). Building it by hand meant working through every step of the methodology myself: pulling 10-Ks off SEC EDGAR, sourcing WACC inputs from FRED and Damodaran's data, building the forecast, discounting the cash flows, and stress-testing the output. This project takes that exact methodology and turns it into reusable code, so the same rigor applies to any company, not just one.
